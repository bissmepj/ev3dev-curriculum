...
Authors: David Fisher and Carson Meyer.  February 2017.
...
def main():
    ...
    mqtt_client = com.MqttClient()    #Sets up a MQTT client to communicate with EV3
    ...
    while not robot.touch_sensor.is_pressed:
        ...
        x = robot.pixy.value(1)         #Gathers and stores the values form the pixy camera for later use
